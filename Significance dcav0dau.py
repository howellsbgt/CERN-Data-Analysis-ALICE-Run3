...
cut_values = df['Cut'][0:20]
cut_values1 = df['Cut'][17:20]
significance_values = df['Significance'][0:20]
significance_values1 = df['Significance'][17:20]
error_values = df['Error'][0:20]
fraction_left_values = df['Frac Left'][0:20]
MC_fraction_left_values = df['MCTR FL'][0:20]
...
params, covariance = curve_fit(significance_function, cut_values1, significance_values1, sigma=error_values[17:20])
...
plt.savefig('v0cospa_K0_significance_plot.png', dpi=300, bbox_inches='tight')
